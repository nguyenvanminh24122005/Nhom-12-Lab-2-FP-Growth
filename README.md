# Nhóm 12 – Lab 2: Market Basket Analysis with FP-Growth


## Mục tiêu
Thực hiện phân tích giỏ hàng (Market Basket Analysis) bằng thuật toán FP-Growth trên bộ dữ liệu Online Retail nhằm khai phá các tập phổ biến và luật kết hợp giữa các sản phẩm.
Đồng thời so sánh hiệu quả của FP-Growth với thuật toán Apriori về thời gian xử lý và khả năng mở rộng trên tập dữ liệu lớn.
